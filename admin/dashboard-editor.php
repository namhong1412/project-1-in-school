...
<body>
    ...
    <script>
        ...
        function get_list_editor() {
            ...
            .then(data => {
                ...
                for (a of data.result) {
                    editor.insertAdjacentHTML('beforeend',"<tr><td>"+a.name+"</td><td>"+a.email+"</td><td><button onclick='lock_editor("+a.id+")' class='button-delete'>"+a.status+"</button></td></tr>");
                }
            })
            .catch((error) => {
              console.error('Error:', error);
        ...
        function lock_editor(_id) {
            fetch('../api/editor/delete.php', {
                method: 'POST',
                headers: {
                'Content-Type': 'application/json',
                },
